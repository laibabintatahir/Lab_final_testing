...
public class UtilsSet {
    ...
    public static void waitUntilClickable(By locator, int timeoutSeconds) {
        WebDriver driver = getDriver();
        int attempt = 0;
        while (attempt < timeoutSeconds * 2) {
            try {
            ...
            try {
                Thread.sleep(2000); // Wait for 2000 milliseconds before retrying
